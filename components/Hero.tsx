...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen bg-[#011936] flex flex-col items-center justify-center overflow-hidden pt-32 px-4 sm:px-8 lg:px-16">
      <div
        className="absolute inset-0 opacity-10 pointer-events-none"
        style={{
          backgroundImage:
            "radial-gradient(circle, #56DFCF 1px, transparent 1px)",
          backgroundSize: "30px 30px",
        }}
      />

      <div className="w-full max-w-7xl relative flex flex-col lg:flex-row justify-between items-center z-10 py-12 lg:py-20">
        ...
        <div className="w-full lg:w-5/12 h-[300px] lg:h-[450px] mt-8 lg:mt-0 z-20 pointer-events-none animate-in fade-in slide-in-from-right-12 duration-1000 delay-200">
